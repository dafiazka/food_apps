...
import 'package:food_apps/screens/cart4.dart';
import 'package:food_apps/screens/confirm_screen4.dart';
...
class DetailScreen4 extends StatefulWidget {
  ...
  @override
  State<DetailScreen4> createState() => _DetailScreen4();
}
...
class _DetailScreen4 extends State<DetailScreen4> {
  ...
  int dataPrice = 22000;
  int dataPricePromo = 16000;

  int price = 22000;
  int pricePromo = 16000;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              width: MediaQuery.of(context).size.width,
                              child: Text(
                                'Promo ini terbatas, hanya berlaku sampai 12 Juli 2022. Jangan sampai kehabisan!',
                                style: poppinsTextStyle.copyWith(
                                  fontSize: 14,
                            ...
                            InkWell(
                              onTap: () {
                                launchUrl(
                                    'https://goo.gl/maps/JoCViVZD2a77sUDQ6');
                              },
                              child: Row(
                                children: [
                                  Image.asset(
