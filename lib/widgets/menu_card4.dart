...
import 'package:food_apps/screens/detail_screen.dart';
import 'package:food_apps/screens/detail_screen4.dart';
import 'package:food_apps/theme.dart';

class MenuCard4 extends StatelessWidget {
  final Menu menu;
  const MenuCard4(this.menu, {Key? key}) : super(key: key);
